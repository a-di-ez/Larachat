...
@section('body.class', 'page-faq site-navbar-small')
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="chat">
                        <div style="display:table; width: 100%; margin-bottom: 10px;">
                            <span style="display:table-cell; width: 100px;">Your name: <strong>@{{ userName }}</strong></span>
                        </div>

                        <ul id="chatMessages">
                            @foreach ($chat->messages as $message)
                                <li class="message @if ($message->user->email == $user_email) mine @else user @endif ">
                                    <span class="who">@if ($message->user->email == $user_email) Me @else {{ $message->user->name }} @endif: </span>{{ $message->text }}
                                </li>
                            @endforeach
                        ...
                        <div style="display:table; width: 100%;">
						    <span style="display:table-cell; width: 100px;">Say something:</span>
